...
- Panels 1 to 3: φ vs ψ surface plots, focusing on positions 1, 2, and 3 respectively
- Panels 4 to 6: the corresponding stats views for the same three positions
...
- **Char 1 to 3**, the three triplet residues (one-letter codes; `X` for Any). **The UPPERCASE one is the focused position.**
