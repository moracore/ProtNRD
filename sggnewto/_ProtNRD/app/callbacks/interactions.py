...
from constants import (
    ...
    NON_TORSION_INVARIANTS, AMINO_ACID_NAMES
)
import io
import csv
import numpy as np
...
def register_interaction_callbacks(app):
    ...
    @app.callback(
        ...
        Output('pos-0-checkbox', 'value'),
        Output('pos-1-checkbox', 'value'),
    ...
    def update_active_panel(config_clicks, placeholder_clicks, panel_states_json, sci_notation_pref):
        ...
        try:
            ...
            elif 'prop_id' in triggered_id_dict: prop_id_str = triggered_id_dict['prop_id'].split('.')[0]; parsed_id = json.loads(prop_id_str.replace("'", '"')); active_panel_index = parsed_id['index'];
    ...
    @app.callback(
        ...
        Input('pos-0-checkbox', 'value'),
        Input('pos-1-checkbox', 'value'),
    ...
    def update_checkbox_exclusivity(pos0_val, pos1_val, offset):
        ...
        if triggered_id == 'pos-0-checkbox':
            return pos0_val, not pos0_val
        elif triggered_id == 'pos-1-checkbox':
            return not pos1_val, pos1_val
    ...
    @app.callback(
        ...
        Output('pos-0-checkbox', 'style'),
        Output('pos-0-checkbox', 'disabled'),
        Output('pos-1-checkbox', 'style'),
    ...
    def manage_config_panel_layout(offset, inv1, inv2):
        ...
        show_style_block = {'display': 'block'}
        
        res1_style, res2_style = show_style_block, show_style_block
        pos0_style, pos0_disabled, pos1_style = show_style_block, False, show_style_block

        if offset == 0:
            res2_style = hide_style
            pos0_disabled = True
            pos1_style = hide_style
        ...
        if plot_type == 'STATS_ONLY':
            return res1_style, res2_style, pos0_style, pos0_disabled, pos1_style, \
                   hide_style, no_update, no_update, no_update, no_update, \
                   inv1_options, inv2_options
        
        elif plot_type == '1D_HISTO':
            x_style, y_style = show_style_block, hide_style
            map_style, scale_style = hide_style, show_style_block
            
            if inv2_type == 'TORSION':
                x_style, y_style = y_style, x_style
            
            return res1_style, res2_style, pos0_style, pos0_disabled, pos1_style, \
                   show_style_block, x_style, y_style, map_style, scale_style, \
                   inv1_options, inv2_options

        elif plot_type == '3D_HEATMAP':
            return res1_style, res2_style, pos0_style, pos0_disabled, pos1_style, \
                   show_style_block, show_style_block, show_style_block, show_style_block, show_style_block, \
                   inv1_options, inv2_options
