...
2. Choose a **Residue Step**: how far apart the two residues are in the chain (0 = same position, 1 to 4 = neighbours).
...
- **Residue Step**, chain distance between the two residues (0 to 4). At Step 0 both positions describe the same residue, so Residue 2 has no additional effect.
...
- **Char 3**, Step (0 to 4), the chain distance between the two residues. At Step 0 both describe the same residue.
